"""Setup script for the aruco_map_locator package."""
...
setup(
    ...
    install_requires=["setuptools", "numpy", "pyyaml", "opencv-contrib-python"],
    zip_safe=True,
    maintainer="mowibox",
    maintainer_email="ousmane.thiongane@outlook.com",
